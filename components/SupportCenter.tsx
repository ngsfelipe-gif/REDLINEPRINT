    ...
    <div className="max-w-7xl mx-auto px-6 py-24 animate-in fade-in duration-700">
      <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-12">
        <div className="max-w-3xl">
          <h2 className="text-[10px] font-black text-red-600 uppercase tracking-[1em] mb-8">Specialized Support</h2>
        ...
        <div className="bg-black text-white p-12 rounded-[4rem] shadow-2xl">
          <span className="text-[10px] font-black uppercase tracking-widest opacity-60 block mb-4">Média de Resposta</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="bg-black text-white p-12 rounded-[5rem] shadow-2xl group">
          ...
          <h4 className="text-4xl font-brand font-black italic uppercase mb-6 tracking-tighter">Knowledge <br /> Base R2</h4>
          <p className="text-xs text-white/40 font-bold uppercase leading-relaxed tracking-widest mb-10">Guias técnicos sobre sangrias, cores spot e acabamentos especiais.</p>
        ...
        <div className="bg-white border border-gray-100 p-12 rounded-[5rem] shadow-sm hover:shadow-2xl transition-all group">
          ...
          <h4 className="text-4xl font-brand font-black italic uppercase mb-6 tracking-tighter">Tickets <br /> de Produção</h4>
          <p className="text-xs text-gray-400 font-bold uppercase leading-relaxed tracking-widest mb-10">Para questões complexas sobre encomendas em curso.</p>
          <button 
